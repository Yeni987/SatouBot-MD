...
if (!args[0]) return conn.reply(m.chat, `❀ Te faltó un link de un video de youtube`, /*fkontak,*/ m, { contextInfo: { 'forwardingScore': 0, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: `Holis^^ ` + nombre, mediaType: 3, sourceUrl: redes, thumbnail: icons}}}, { quoted: fkontak })
...
await conn.reply(m.chat, `🍭 E S P E R E\n- ?❀ Sᴇ ᴇsᴛᴀ ᴅᴇsᴄᴀʀɢᴀɴᴅᴏ sᴜ ᴠɪᴅᴇᴏ, ᴇsᴘᴇʀᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ..`, m, fake)
try {
let qu = args[1] || '360'
let q = qu + 'p'
let v = youtubeLink
