//
// By @ianalejandro269 || https://github.com/ianalejandrook15x/
//
...
export async function before(m, {conn, isAdmin, isBotAdmin, usedPrefix}) {
  ...
  if (chat.antiTraba && m.text.length > 5000) { // Cantidad máxima de caracteres aceptados en un mensaje//
    ...
    // await conn.sendButton(m.chat, `*[ ! ] Se detecto un mensaje que contiene muchos caracteres [ ! ]*\n`, `${isBotAdmin ? '' : 'No soy administradora, no puedo hacer nada :/'}`, author, ['[ DESACTIVAR ANTI TRABAS ]', usedPrefix+'apagar antitraba'], fakemek )
    ...
    } else if (!bot.restrict) return m.reply('[ ! ] Para realizar acciones de eliminación, mi creador tiene que encender el modo restringido!');
  }
  return !0;
}
