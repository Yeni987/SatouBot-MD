...
text: `🍭 ¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} 🥖 Panes* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} 🥖 Panes* a ${senderName}.`,
contextInfo: { 
...
conn.reply(m.chat, `🍭 No fuiste cuidadoso y te atraparon mientras cometias tu crime, se restaron *-${amountSubtracted} 🥖 Panes* a ${senderName}.`, m, rcanal)
break
case 2:
...
conn.sendMessage(m.chat, {
text: `🍭 Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} 🥖 Panes* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} 🥖 Panes* a ${senderName}.`,
contextInfo: { 
mentionedJid: [randomUserId],
}}, { quoted: m })
break
